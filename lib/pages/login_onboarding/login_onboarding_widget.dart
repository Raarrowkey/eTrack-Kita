...
import 'login_onboarding_model.dart';
export 'login_onboarding_model.dart';

class LoginOnboardingWidget extends StatefulWidget {
  const LoginOnboardingWidget({
    super.key,
    required this.onboardingPARAM,
  });

  final DocumentReference? onboardingPARAM;

  static String routeName = 'Login_Onboarding';
  static String routePath = '/loginOnboarding';

  @override
  State<LoginOnboardingWidget> createState() => _LoginOnboardingWidgetState();
}

class _LoginOnboardingWidgetState extends State<LoginOnboardingWidget> {
  late LoginOnboardingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginOnboardingModel());
                                          ...
                                          builder: (context) => ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              imageUrl: currentUserPhoto != ''
                                                  ? currentUserPhoto
                                                  : _model
                                                      .uploadedFileUrl_profileFirestoreOn,
                                              fit: BoxFit.fill,
                                            ),
                                          ),
                                        ),
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_profileFirestoreOn =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_profileFirestoreOn =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_profileFirestoreOn =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_profileFirestoreOn =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if ((_model.firstNameWIDGETTextController.text ==
                            ...
                            context.goNamed(NavFolderWidget.routeName);
                          }
                        },
                        text: 'Save Changes',
