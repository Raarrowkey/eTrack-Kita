...
class _LoginWidgetState extends State<LoginWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF7FA64B),
        body: SafeArea(
          top: true,
          child: Container(
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              indicatorColor: Color(0xFF5B8DEF),
                              indicatorWeight: 3.0,
                              tabs: [
                                Tab(
                                  text: 'Create Account',
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                await ProfileCollectionRecord
                                                    .collection
                                                    .doc()
                                                    .set(
                                                        createProfileCollectionRecordData(
                                                      userForeignKEY:
                                                          currentUserReference,
                                                    ));
                                                FFAppState().showOnboard = true;
                                                safeSetState(() {});
                                                safeSetState(() {
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (FFAppState().showOnboard ==
                                                  ...
                                                  await actions
                                                    ...
                                                    getCurrentTimestamp
                                                        .secondsSinceEpoch,
                                                    'Welcome to eTrack Kita!',
                                                    'New User, Please Introduce Yourself!',
